...
<div className="w-4/5  mx-auto mt-20 pb-10">
      <div className="flex flex-row  w-full mx-auto">
        <img src="\img\products-kite.png" className="w-[45%] mr-[15%]" alt="" />
        <div className="pt-16  w-[35%]">
          ...
          <p className="text-2xl text-gray-700">
            ...
            advanced analytics, and personalized AI-driven investment plans, all
      ...
      <div className="flex flex-row  w-11/12 mx-auto mt-36">
        ...
        <div className="pt-16  w-[35%] mt-10">
          ...
          <p className="text-2xl text-gray-700">
            ...
            incidunt eaque ipsa unde, maiores adipisci ducimus eius itaque
            suscipit! Quam facere sit commodi volup
          </p>
      ...
      <div className="flex flex-row text-2xl text-center justify-center gap-28 mt-5 mb-14 ">
        <p className="w-1/4">Create Free account on GCP with assistance from our AI</p>
        <p className="w-1/4">Get Personalized Investment plans specially made for you</p>
        <p className="w-1/4">Got any doubt? Get free Consualtation with our experts</p>
