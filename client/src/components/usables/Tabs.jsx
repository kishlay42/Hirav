      ...
      content:{
        data: [ 
          ...
          { 
              ...
              title: '  How does Hirav ensure the sustainability and profitability of its investment plans?', 
      ...
      content:{
        data: [ 
          { 
              ...
              title: 'How does investing through Hirav contribute to environmental sustainability?', 
    ...
    <div>
      ...
      <div className="py-4 px-14">
        ...
        { tabsData[activeTabIndex].content.data.map((tab, idx) => {
          return (
            <Accordion  title={tab.title} answer={tab.data} />
          );
